...
const QuizPage = ({ module, nextModule }) => {
    ...
    const getRandomChar = () => {
        const chars = isRetakingQuiz ? retakeQuizCharPool : moduleCharacters;
    ...
    const takeNewQuiz = () => {
        setRetakeQuizCharPool([...moduleCharacters]);
    ...
    const retakeQuiz = () => {
        ...
        const unseenArray = moduleCharacters.filter(char => !seenCharacters.has(char));
